...
public:
    ...
    void setupUi(QDialog *PreferencesDialog)
    {
        ...
        checkShowDataTab = new QCheckBox(verticalLayoutWidget);
        checkShowDataTab->setObjectName("checkShowDataTab");
        checkShowDataTab->setChecked(false);

        verticalLayout->addWidget(checkShowDataTab);
