...
public:
    ...
    void setupUi(QMainWindow *ValveWorkbench)
    {
        ...
        layoutWidget->setGeometry(QRect(10, 10, 312, 670));
        ...
        label->setGeometry(QRect(0, 130, 310, 20));
