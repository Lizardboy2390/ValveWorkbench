...
#define MASTER_ADDR 0x0A     //I2C Address of the Arduino
...
#define DO_NOT_USE_PIN 5     //Pin used as a tie point for Vcc on PCB
...
#define HV_ACCURACY 1 // Tolerance on setting HV
#define IA_ACCURACY 5
#define IA_SAMPLES 8
#define IA_RETRY_LIMIT 4
/************************************************************   
*FUNCTION PROTOTYPES
************************************************************/
